...
BeginPackage["AntonAntonov`EpidemiologicalModeling`Models`"];
...
Clear[EpidemiologicalModelQ];
EpidemiologicalModelQ[model_] :=
    AssociationQ[model] &&
...
EpidemiologyModelQ = EpidemiologicalModelQ;


Clear[EpidemiologicalFullModelQ];
EpidemiologicalFullModelQ[model_] :=
    AssociationQ[model] &&
...
EpidemiologyFullModelQ = EpidemiologicalFullModelQ;
...
ModelGridTableForm[modelArg_?EpidemiologicalModelQ, opts : OptionsPattern[] ] :=
    Block[{model = modelArg, tooltipsQ, aTHeadings, aTooltipRules},
      ...
      If[tooltipsQ,
        ...
        If[ EpidemiologicalFullModelQ[model],
